...
// production
// const esmPath = "public/dist/visualization.esm.min.js"
// const umdPath = "public/dist/visualization.umd.min.js"
// const cjsPath = "public/dist/visualization.cjs.min.js"
...
if (process.env.BUILD === "dev") {
  config = {
    input: "./src/index.js",
    output: {
      file: "public/dist/visualization.dev.js",
      format: "esm",
      sourcemap: true,
      name: "Visualization",
    },
    plugins: [
      ...
      commonjs(),
      url({ limit: 10 * 1024, include: ["**/*.svg"], emitFiles: true }),
    ],
  }
}
