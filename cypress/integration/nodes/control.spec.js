...
before(() => {
    ...
    cy.fixture("control").then((databaseEntry) => {
        data = databaseEntry
        min = new Control(databaseEntry, canvas)
        max = new Control(databaseEntry, canvas)
    })
})


describe("control node test", () => {
    it("renderAsMin()", () => {
        ...
        expect(min.getCurrentWidth()).to.equal(150)
        ...
        it("renderAsMax()", () => {
            ...
            expect(max.getCurrentWidth()).to.equal(400)
            expect(max.getCurrentHeight()).to.equal(190)
